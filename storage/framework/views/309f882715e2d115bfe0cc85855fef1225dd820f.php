        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <a href="<?php echo e(url('/Kategori_Lembur')); ?>" class="btn btn-success btn-block">Kembali</a><br>
                    <?php echo Form::model($kalemv,['method'=>'PATCH','route'=>['Kategori_Lembur.update',$kalemv->id]]); ?>
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group">
                                <select name="jabatan_id" class="form-control" required>
                                    <option value="<?php echo e($kalemv->jabatan->id); ?>">Nama Jabatan -- <?php echo e($kalemv->jabatan->nama_jabatan); ?></option>
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group">
                                <select name="golongan_id" class="form-control" required>
                                    <option value="<?php echo e($kalemv->golongan->id); ?>">Nama Golongan -- <?php echo e($kalemv->golongan->nama_golongan); ?></option>
