            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <?php echo Form::model($pegawaiv,['method'=>'PATCH','route'=>['Pegawai.update',$pegawaiv->id],'files'=>'true']); ?>
                        ...
                        <label>NIP</label>
                        <input type="text" name="nip" value="<?php echo e($pegawaiv->nip); ?>" class="form-control" required><br>

                        <div class="form-group">
                            <label for="jabatan_id" class="form-group">Nama Jabatan</label>
                            <div class="form-group">
                                <select name="jabatan_id" class="form-control" required>
                                    <option value="<?php echo e($pegawaiv->jabatan->id); ?>">Nama Jabatan ( <?php echo e($pegawaiv->jabatan->nama_jabatan); ?> ) </option>
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group">
                                <select name="golongan_id" class="form-control" required>
                                    <option value="<?php echo e($pegawaiv->golongan->id); ?>">Nama Golongan ( <?php echo e($pegawaiv->golongan->nama_golongan); ?> ) </option>
