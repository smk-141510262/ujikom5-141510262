                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group">
                                <select name="jabatan_id" class="form-control" required>
                                    <option value="<?php echo e($tunjanganv->jabatan->id); ?>">Nama Jabatan ( <?php echo e($tunjanganv->jabatan->nama_jabatan); ?> )  </option>
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group">
                                <select name="golongan_id" class="form-control" required>
                                    <option value="<?php echo e($tunjanganv->golongan->id); ?>">Nama Golongan ( <?php echo e($tunjanganv->golongan->nama_golongan); ?> ) </option>
